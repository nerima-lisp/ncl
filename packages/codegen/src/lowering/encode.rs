//! Instruction encoding pass and safepoint map registration.

use super::ops::lower_op;
use super::support::{emit, load};
use crate::{
    CodegenError, CompiledFunction, FLAG_CALL, FLAG_LOOP_BACKEDGE, FrameLayout, MachineFunction,
    RuntimeAbi, SafepointMap, checked_i64, checked_u16, checked_u32,
};
use ncl_asm_x86_64::{Assembler, BinOp, Cond, Imm, Inst, Reg};
