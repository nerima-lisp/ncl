//! Operation lowering for the fixed-template backend.

use super::encode::add_map;
use super::support::{emit, load, store};
use crate::{
    CodegenError, ConstantName, FLAG_ALLOCATION_SLOW, FLAG_CALL, FrameLayout, RuntimeAbi,
    SafepointMap, checked_i64,
};
