pub(super) fn is_shadowable_primitive(name: &str) -> bool {
    is_composite_list_accessor(name) || matches!(
        ...
        "FIND" | "POSITION" | "COUNT" | "FIND-IF" | "POSITION-IF" | "COUNT-IF"
            ...
            | "ARRAY-ELEMENT-TYPE" | "ARRAY-HAS-FILL-POINTER-P" | "ADJUSTABLE-ARRAY-P" | "ARRAY-DISPLACEMENT" | "ARRAY-RANK" | "ARRAY-DIMENSIONS" | "ARRAY-DIMENSION"
            ...
            | "GENSYM" | "INTERN" | "FIND-SYMBOL" | "SUBTYPEP" | "CLASS-OF" | "FIND-CLASS" | "CLASS-PRECEDENCE-LIST"
            | "CLASS-NAME" | "CLASS-DIRECT-SUPERCLASSES" | "SLOT-VALUE" | "SLOT-EXISTS-P" | "SLOT-BOUNDP" | "SLOT-MAKUNBOUND"
            ...
            | "MAKE-HASH-TABLE" | "CLRHASH" | "HASH-TABLE-COUNT" | "HASH-TABLE-SIZE"
            | "HASH-TABLE-TEST"
