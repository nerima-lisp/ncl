...
pub enum Instruction {
    ...
    #[doc = "Mark a variable as locally special."] DeclareSpecial(String),
    #[doc = "Mark an escaped variable as locally special."] DeclareSpecialExact(String),
    #[doc = "Define a function."] DefineFunction(String),
    #[doc = "Define an escaped function name."] DefineFunctionExact(String),
    #[doc = "Define a constant."] DefineConstant(String),
    #[doc = "Define an escaped constant."] DefineConstantExact(String),
    ...
    #[doc = "Capture each place before its compiled RHS, then store before the next pair."] SetfPlaces {
        invocation: Form,
        values: Vec<FunctionId>,
    },
    #[doc = "Modify a runtime-expanded place with a compiled delta."] ModifyPlace {
        invocation: Form,
        delta: FunctionId,
        arithmetic: String,
    },
    #[doc = "Update a CAR/CDR/FIRST/REST place whose argument is already evaluated."] SetfListPlace {
        operator: String,
        place: Form,
    },
    #[doc = "Update an NTH place whose index and list value are already evaluated."] SetfNthPlace { place: Form },
    #[doc = "Update a one-dimensional AREF vector place whose operands are evaluated."] SetfArefVectorPlace { place: Form },
    #[doc = "Update a multidimensional AREF array place whose operands are evaluated."] SetfArefArrayPlace {
        index_count: usize,
        place: Form,
    },
    #[doc = "Update a BIT place whose operands are evaluated."] SetfBitPlace {
        index_count: usize,
        place: Form,
    },
    #[doc = "Update a GETHASH place whose key and table are evaluated."] SetfGethashPlace { place: Form },
    #[doc = "Update a GETF place whose plist and indicator are evaluated."] SetfGetfPlace { place: Form },
    #[doc = "Update a ROW-MAJOR-AREF place whose operands are evaluated."] SetfRowMajorArefPlace { place: Form },
    #[doc = "Update an SVREF place whose operands are evaluated."] SetfSvrefPlace { place: Form },
    #[doc = "Update a string character place whose operands are evaluated."] SetfStringCharPlace {
        operator: String,
        place: Form,
    },
    #[doc = "Update an ELT place whose operands are evaluated."] SetfEltPlace { place: Form },
    #[doc = "Update a SUBSEQ place whose operands are evaluated."] SetfSubseqPlace { place: Form },
    #[doc = "Pop the value from an evaluated CAR/CDR/FIRST/REST place."] PopListPlace {
        operator: String,
        place: Form,
    },
    #[doc = "Pop the value from an evaluated NTH place."] PopNthPlace { place: Form },
    #[doc = "Push an item into an evaluated NTH place."] PushNthPlace { place: Form },
    #[doc = "Push an item into an evaluated NTH place unless already EQL."] PushnewNthPlace { place: Form },
    #[doc = "Push an item into an evaluated CAR/CDR/FIRST/REST place."] PushListPlace {
        operator: String,
        place: Form,
    },
    #[doc = "Push an item into an evaluated GETF place."] PushGetfPlace { place: Form },
    #[doc = "Push an item unless already EQL in an evaluated GETF place."] PushnewGetfPlace { place: Form },
    #[doc = "Push an item unless already EQL in an evaluated CAR/CDR/FIRST/REST place."] PushnewListPlace {
        operator: String,
        place: Form,
        options: Vec<PushnewOption>,
    },
    ...
    #[doc = "Push a value onto a dynamically indexed list element through NTH with comparison options."] ListMutationNthPushNewOptions {
        /// The symbol holding the outer list.
        name: String,
        /// Whether the symbol name is escaped.
        escaped: bool,
    ...
    #[doc = "Push a value onto a dynamically indexed nested list element through NTH with comparison options."] NestedListMutationNthPushNewOptions {
        /// Accessors from the symbol outward to the list being indexed.
        accessors: Vec<String>,
        /// The symbol holding the outer list.
        name: String,
    ...
    #[doc = "Update an evaluated vector or array target through an array accessor."] SetfArefValue {
        /// The number of subscripts.
        rank: usize,
        /// The accessor name.
        operator: String,
    ...
    #[doc = "Update the fill pointer of an evaluated vector target."] SetfFillPointerValue,
    ...
    #[doc = "Update an evaluated integer place through LDB or MASK-FIELD."] SetfBitfieldValue {
        /// The bitfield place operator.
        operator: String,
    },
    ...
    #[doc = "Apply MAP-INTO to an AREF vector place whose operands are evaluated once."] MapIntoArefVectorPlace {
        sequence_count: usize,
        place: Form,
    },
    #[doc = "Apply MAP-INTO to a CAR/CDR/FIRST/REST place whose argument is evaluated once."] MapIntoListPlace {
        operator: String,
        place: Form,
        sequence_count: usize,
    },
    #[doc = "Apply MAP-INTO to an NTH place whose operands are evaluated once."] MapIntoNthPlace {
        sequence_count: usize,
        place: Form,
    },
    #[doc = "Perform parallel assignment to evaluated CAR/CDR/FIRST/REST places."] PsetfListPlaces(Vec<(String, Form)>),
    #[doc = "Shift values through escaped or normal symbol places."] Shiftf(Vec<(String, bool)>),
    #[doc = "Shift values through evaluated CAR/CDR/FIRST/REST places."] ShiftfListPlaces(Vec<(String, Form)>),
    #[doc = "Rotate values through evaluated CAR/CDR/FIRST/REST places."] RotatefListPlaces(Vec<(String, Form)>),
    ...
    #[doc = "Exchange the two top stack values."] Swap,
    #[doc = "Replace the stack with the primary value."] Primary,
    #[doc = "Select one value from a multiple-value carrier."] NthValue,
    #[doc = "Validate the top stack value as an NTH-VALUE index without consuming it."] CheckNthValueIndex(Span),
    ...
    #[doc = "Evaluate retained syntax without converting embedded literals back to source."] EvalForm(Form),
    ...
    #[doc = "Apply an integer parsing operation."] IntegerOperation {
        /// Integer operation name.
        operation: String,
        /// Number of arguments supplied to the operation.
        argument_count: usize,
    },
    ...
    #[doc = "Apply a file metadata operation."] FileMetadataOperation {
        /// File metadata operation name.
        operation: String,
        /// Number of arguments supplied to the operation.
        argument_count: usize,
    },
