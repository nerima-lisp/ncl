...
fn emits_eval_and_mapcar_instructions() {
    ...
    for (operation, source, argument_count) in [
        ...
        ("ARRAY-ROW-MAJOR-INDEX", "(array-row-major-index #(1 2) 1)", 2),
    ...
    for operation in ["ATOM", "CONSP", "LISTP", "NUMBERP", "INTEGERP", "STRINGP", "CHARACTERP", "SYMBOLP", "VECTORP", "FUNCTIONP", "SIMPLE-VECTOR-P", "BIT-VECTOR-P", "SIMPLE-BIT-VECTOR-P", "ARRAYP", "SIMPLE-ARRAY-P", "HASH-TABLE-P", "RANDOM-STATE-P", "STREAMP", "INPUT-STREAM-P", "OUTPUT-STREAM-P", "OPEN-STREAM-P"] {
    ...
    for operation in ["AREF", "SVREF", "BIT", "ROW-MAJOR-AREF", "ARRAY-ROW-MAJOR-INDEX", "ARRAY-IN-BOUNDS-P"] {
    ...
    assert!(vector.functions[0].instructions.iter().any(|instruction| {
        matches!(instruction, Instruction::VectorConstruction { argument_count: 2 })
    }));
    ...
    let string_comparisons = compile("(list (string= \"a\" \"a\") (string-equal \"A\" \"a\") (string< \"a\" \"b\") (string> \"b\" \"a\") (string<= \"a\" \"a\") (string>= \"b\" \"a\"))");
    assert_eq!(
