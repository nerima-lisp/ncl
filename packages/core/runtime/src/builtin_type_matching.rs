...
pub(super) fn type_matches_designator(
    function: &str,
    value: &Value,
...
pub(super) fn type_matches_compound(
    function: &str,
    value: &Value,
    items: &[Value],
) -> Result<bool, RuntimeError> {
...
pub(super) fn require_type_spec_arity(
    function: &str,
    operator: &str,
    arguments: &[Value],
    minimum: usize,
...
pub(super) fn invalid_type_spec(function: &str, message: impl Into<String>) -> RuntimeError {
...
pub(super) fn integer_type_matches(
    function: &str,
    value: &Value,
    arguments: &[Value],
) -> Result<bool, RuntimeError> {
...
pub(super) fn integer_type_bound(
    function: &str,
    value: &Value,
...
pub(super) fn unsigned_byte_type_matches(
    function: &str,
    value: &Value,
    arguments: &[Value],
) -> Result<bool, RuntimeError> {
...
pub(super) fn signed_byte_type_matches(
    function: &str,
    value: &Value,
    arguments: &[Value],
) -> Result<bool, RuntimeError> {
...
pub(super) fn cons_type_matches(
    function: &str,
    value: &Value,
    arguments: &[Value],
) -> Result<bool, RuntimeError> {
...
pub(super) fn cons_parts(value: &Value) -> Option<(Value, Value)> {
    match value {
...
pub(super) fn vector_type_matches(
    function: &str,
    value: &Value,
    arguments: &[Value],
) -> Result<bool, RuntimeError> {
...
pub(super) fn simple_vector_type_matches(
    function: &str,
    value: &Value,
    arguments: &[Value],
) -> Result<bool, RuntimeError> {
...
pub(super) fn bit_vector_type_matches(
    function: &str,
    value: &Value,
    arguments: &[Value],
) -> Result<bool, RuntimeError> {
...
pub(super) fn is_bit_vector_value(value: &Value) -> bool {
    matches!(value, Value::Vector(items) if items.iter().all(is_bit_value))
}

const fn is_bit_value(value: &Value) -> bool {
    matches!(value, Value::Integer(bit) if *bit == 0 || *bit == 1)
}

pub(super) fn array_type_matches(
    function: &str,
    operator: &str,
    value: &Value,
    arguments: &[Value],
...
pub(super) fn type_matches_element_spec(
    function: &str,
    value: &Value,
    type_designator: &Value,
) -> Result<bool, RuntimeError> {
...
pub(super) fn type_spec_size(function: &str, value: &Value) -> Result<Option<usize>, RuntimeError> {
    if is_type_wildcard(value) {
        return Ok(None);
    }
...
pub(super) fn array_dimensions_match(
    function: &str,
    expected: &Value,
    actual: &[usize],
) -> Result<bool, RuntimeError> {
...
pub(super) fn is_type_wildcard(value: &Value) -> bool {
    value
        .symbol_name()
        .is_some_and(|name| name.eq_ignore_ascii_case("*"))
}

pub(super) fn type_matches(value: &Value, type_name: &str) -> Result<bool, RuntimeError> {
