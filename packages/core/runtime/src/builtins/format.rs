...
pub(crate) fn format_value(arguments: &[Value]) -> Result<Value, RuntimeError> {
    if arguments.len() < 2 {
...
#[derive(Clone, Copy)]
pub(crate) enum FormatParameter {
    Missing,
    Number(i64),
    Character(char),
}
...
#[derive(Clone, Copy)]
pub(crate) struct FormatTermination {
    colon_modifier: bool,
}
...
pub(crate) fn format_directive_prefix(
    characters: &[char],
    start: usize,
...
pub(crate) fn format_general_float_directive(
    value: f64,
    parameters: &[FormatParameter],
    colon_modifier: bool,
    at_sign_modifier: bool,
...
pub(crate) fn format_exponential_float_directive(
    value: f64,
    parameters: &[FormatParameter],
    colon_modifier: bool,
    at_sign_modifier: bool,
...
pub(crate) fn format_english_number(value: i64, ordinal: bool) -> String {
    if value < 0 {
        if value == i64::MIN {
            return format!(
                "minus {}",
...
pub(crate) fn format_roman_number(value: i64, old_style: bool) -> String {
    if value == 0 {
        return "N".to_string();
    }
...
pub(crate) fn format_integer_radix(value: i64, radix: u32) -> String {
...
pub(crate) fn format_unsigned_integer(mut magnitude: u64, radix: u32) -> String {
...
impl Number {
    ...
    pub(crate) fn exact_parts(self) -> Option<(i64, i64)> {
        match self {
