...
impl Runtime {
    ...
    pub(super) fn expand_symbol_macro_form(
        form: &Form,
    ...
    pub(super) fn symbol_macro_temporary(form: &Form, index: usize, span: Span) -> Form {
        Form::atom(
            format!(
