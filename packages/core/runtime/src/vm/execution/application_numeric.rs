...
pub fn execute_numeric_fold_instruction(
    ...
    let arguments = stack
        ...
        .collect::<Vec<_>>();
    let result = match operation {
        "+" => crate::builtins::add(&arguments),
        "-" => crate::builtins::subtract(&arguments),
        "*" => crate::builtins::multiply(&arguments),
        "/" => crate::builtins::divide(&arguments),
...
pub fn execute_numeric_random_instruction(
    ...
    stack.push(crate::builtins::with_random_state_context(state, || {
        crate::builtins::random(&arguments)
    })?);
    Ok(())
}
