...
pub fn execute_package_mutation_instruction(
    ...
    let value = match operation {
        "MAKE-PACKAGE" => runtime.apply_package_creation_primitive(operation, &arguments, span),
        "RENAME-PACKAGE" | "DELETE-PACKAGE" => runtime
            .apply_package_lifecycle_primitive(operation, &arguments, span)
            .or_else(|| runtime.apply_package_creation_primitive(operation, &arguments, span)),
