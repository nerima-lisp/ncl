...
pub(super) fn execute_value_instruction(
    ...
    match instruction {
        ...
        Instruction::Eval(form_span) => {
            ...
            let global = runtime.global_environment();
            stack.push(runtime.eval_values_in(&form, &global)?);
        }
        ...
        Instruction::SequenceMapping { sequence_count } => {
            execute_sequence_mapping_instruction(
                runtime,
                *sequence_count,
                stack,
                environment,
        ...
        Instruction::SequencePairSearch {
            ...
            execute_sequence_pair_search_instruction(
                runtime,
                operation,
                *option_count,
                stack,
        ...
        Instruction::AssociationSearch {
            ...
            execute_association_search_instruction(
                runtime,
                operation,
                *predicate,
                *option_count,
        ...
        Instruction::SequenceRemoval {
            ...
            execute_sequence_removal_instruction(
                runtime,
                operation,
                *predicate,
                *duplicates,
        ...
        Instruction::NumericRandom { argument_count } => {
            execute_numeric_random_instruction(runtime, stack, *argument_count, environment, span)?;
        }
        ...
        Instruction::IntegerOperation {
            ...
            execute_integer_operation_instruction(operation, *argument_count, stack, span)?;
        }
        ...
        Instruction::VectorOperation {
            ...
            execute_vector_operation_instruction(operation, *argument_count, stack, span)?;
        }
        Instruction::StreamOperation {
            operation,
            argument_count,
        } => {
            execute_stream_operation_instruction(
                runtime,
                operation,
                *argument_count,
                stack,
        ...
        Instruction::SymbolBinding {
            ...
            execute_symbol_binding_instruction(
                runtime,
                stack,
                environment,
                operation,
        ...
        Instruction::SymbolFunction {
            ...
            execute_symbol_function_instruction(
                runtime,
                stack,
                environment,
                operation,
        ...
        Instruction::ClassIntrospection {
            ...
            execute_class_introspection_instruction(
                runtime,
                stack,
                environment,
                operation,
        ...
        Instruction::ConditionOperation {
            ...
            execute_condition_operation_instruction(
                runtime,
                stack,
                environment,
                operation,
        ...
        Instruction::RestartOperation {
            ...
            execute_restart_operation_instruction(
                runtime,
                stack,
                environment,
                operation,
        ...
        Instruction::MethodOperation {
            ...
            execute_method_operation_instruction(
                runtime,
                stack,
                environment,
                operation,
        ...
        Instruction::EvaluationOperation {
            ...
            execute_evaluation_operation_instruction(
                runtime,
                stack,
                environment,
                operation,
        ...
        Instruction::PackageIntrospection {
            ...
            execute_package_introspection_instruction(
                runtime,
                stack,
                operation,
                *argument_count,
