...
pub(super) fn execute_value_instruction(
    ...
    match instruction {
        ...
        Instruction::IntegerOperation { operation, argument_count } => {
        ...
        Instruction::VectorOperation { operation, argument_count } => {
            execute_vector_operation_instruction(operation, *argument_count, stack, span)?;
        }
        Instruction::StreamOperation { operation, argument_count } => {
