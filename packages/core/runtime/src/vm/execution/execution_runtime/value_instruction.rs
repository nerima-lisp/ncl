...
use crate::vm::execution::application::{
    ...
    execute_property_list_instruction, execute_symbol_value_instruction,
...
pub(super) fn execute_value_instruction(
    ...
    match instruction {
        ...
        Instruction::SymbolValue { operation } => {
            execute_symbol_value_instruction(runtime, stack, environment, operation, span)?;
        }
