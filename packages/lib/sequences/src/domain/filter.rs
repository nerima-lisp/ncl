...
const RANGE_ONLY_KEYS: &[Parameter] = &[START, END];
...
pub fn filter_entry(name: &str) -> Option<BuiltinImplementation> {
    ...
    let implementation = match name {
        ...
        "FILL" => BuiltinImplementation::adapted(
            Builtin {
                lambda_list: LambdaList::new(&[SEQ, ITEM], &[], None, RANGE_ONLY_KEYS, true),
                convention: BuiltinConvention::Adapted,
            },
            fill_entry_callback,
            pass,
        ...
        "REPLACE" => BuiltinImplementation::adapted(
            Builtin {
                lambda_list: LambdaList::new(&[SEQ, SEQ], &[], None, RANGE_ONLY_KEYS, true),
                convention: BuiltinConvention::Adapted,
            },
